...
export const products: Product[] = [
  ...
  {
    id: "w7",
    name: "Calcinha Rendada Brisa",
    price: 119,
    image: productWhite1,
    category: "lingerie",
    style: "white",
    description: "Renda floral delicada com cintura baixa. Conforto que acompanha você o dia inteiro com elegância discreta.",
    sizes: ["P", "M", "G", "GG"],
    isBestseller: true,
    rating: 4.7,
    reviews: 89,
  },
  {
    ...
    category: "lingerie",
    style: "white",
    description: "Bojo moldado com renda nas laterais. Sustentação perfeita com a delicadeza que define a coleção WHITE.",
    sizes: ["P", "M", "G"],
    isNew: true,
    rating: 4.8,
    reviews: 64,
  ...
  {
    id: "w9",
    name: "Corpete Cetim Divino",
    price: 459,
    image: productWhite3,
    category: "lingerie",
    style: "white",
    description: "Cetim com barbatanas flexíveis e fechamento frontal. Elegância estruturada que valoriza a silhueta com maestria.",
    sizes: ["P", "M", "G", "GG"],
    limitedStock: true,
    rating: 4.9,
    reviews: 22,
  ...
  {
    id: "d7",
    name: "Body Cage Inferno",
    price: 389,
    image: productDark1,
    category: "harness",
    style: "dark",
    description: "Tiras de couro entrelaçadas com argolas metálicas. Arquitetura corporal que transforma o corpo em obra de arte.",
    sizes: ["P", "M", "G", "GG"],
    isNew: true,
    rating: 4.9,
    reviews: 38,
  },
  {
    ...
    category: "acessorio",
    style: "dark",
    description: "Couro trançado com fivela serpente em metal envelhecido. Um acessório que fala antes de você.",
    sizes: ["P", "M", "G"],
    isBestseller: true,
    rating: 4.7,
    reviews: 71,
  ...
  {
    id: "d9",
    name: "Conjunto Sombra",
    price: 479,
    image: productDark3,
    category: "lingerie",
    style: "dark",
    description: "Renda negra com transparência total e detalhes em corrente. Para noites que merecem ser lembradas.",
    sizes: ["P", "M", "G", "GG"],
    limitedStock: true,
    rating: 5.0,
    reviews: 19,
